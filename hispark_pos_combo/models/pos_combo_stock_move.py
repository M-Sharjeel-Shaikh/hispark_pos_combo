...
class PosOrder(models.Model):
    ...
    def _order_fields(self, ui_order):
        ...
        if order_fields['finalized_order'] or order_fields['to_invoice']:
            ...
            order_lines = [process_line(l) for l in ui_order['lines']] if ui_order['lines'] else []
            new_order_line = []
                ...
                if order_line[2].get('combo_ids'):
                    ...
                    if combo_pro_list:
                        for combo in combo_pro_list:
                            combo[2]["full_product_name"] = combo[2].get("name")
                ...
                if order_line[2].get('own_ids'):
                    ...
                    if own_pro_list:
                        for own in own_pro_list:
                            own[2]["full_product_name"] = own[2].get("name")
